...
const nodeColor = (d) => (d.label_id === 4) ? 'rgb(255, 255, 255)' : 'rbg(0, 0, 0)';


function linkLabelID(sourceNodeType, targetNodeType) {
  if (sourceNodeType === 'Explorative' && targetNodeType === 'Explorative') return 5;
  if (sourceNodeType === 'Objective' && targetNodeType === 'Explorative') return 5;
  if (sourceNodeType === 'Explorative' && targetNodeType === 'Objective') return 6;
  if (sourceNodeType === 'Objective' && targetNodeType === 'Objective') return 8;
}
