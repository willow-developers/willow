...
const manuallyAddLinks = require('./addLinks');
const { saveNodes, saveLinks } = require('./saveNodesAndLinks');

// EXAMPLE DATA:
let nodes = [
  ['110227128753222443119', 1, 2, 'Start', '110227128753222443119-1-1526666246059', 90.94002532959, 262.297256469727],
  ['110227128753222443119', 1, 3, 'LEARN CODING', '110227128753222443119-1-1526666518332', 200.689067840576, 257.106170654297],
  ['110227128753222443119', 1, 3, 'CREATE PROJECTS', '110227128753222443119-1-1526666530347', 319.770111083984, 253.362060546875],
  ['110227128753222443119', 1, 4, '3 PROJECTS', '110227128753222443119-1-1526666538043', 439.1513671875, 247.504089355469],
  ['110227128753222443119', 1, 3, 'CREATE RESUME', '110227128753222443119-1-1526666546220', 558.706481933594, 239.820358276368],
  ['110227128753222443119', 1, 4, '1 RESUME', '110227128753222443119-1-1526666554173', 646.566528320312, 236.411743164062],
  ['110227128753222443119', 1, 3, 'APPLY JOBS', '110227128753222443119-1-1526666561262', 756.64166259766, 235.180099487305],
  ['110227128753222443119', 1, 4, '10 JOBS A DAY', '110227128753222443119-1-1526666567924', 851.739318847657, 233.895263671875],
  ['110227128753222443119', 1, 3, 'ACCEPT OFFER', '110227128753222443119-1-1526666577917', 968.410255432125, 228.826263427735],
  ['110227128753222443119', 1, 4, '1 SOFTWARE ENGINEERING JOB', '110227128753222443119-1-1526666585388', 1057.27120971679, 223.168312072754],
];
...
exports.createExampleProject = owner_id => {
  ...
  return knex('projects')
    ...
    .then(project_id => {
      ...
      let formattedLinksWithoutTargets = links.map((link, idx) => {
        return {
          hash_id: `${date}-${owner_id}-${idx}`,
          source_id: '',
          target_id: '',
      ...
      console.log('getting here l80');

      let formattedLinks = addLinks(formattedNodes, formattedLinksWithoutTargets);

      saveNodes(formattedNodes)
        .then(() => {
          console.log('getting here l87');
